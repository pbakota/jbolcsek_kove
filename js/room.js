                ...
                for (var d in Rooms[room].details) {
                    ...
                    switch (ob) {
                        ...
                        case 'tree':
                            ...
                            break;
                        case 'alga_flower':
                            if (!this.#game.rooms.flags['flower_cut']) {
                                this.#flower.draw(ctx, x, y);
                                this.#game.zone.add({
                                    x: x, y: y, w: 8, h: 40, t: 'alga_flower'
                                });
                            }
                            break;
                        case 'princess':
                        ...
                        case 'debris':
                            ...
                            this.#game.zone.add({
                                x: x + 8 + 4, y: y + 16, w: 8, h: 8, t: 'debris_hit'
                            });
                            break;
                        case 'bush':
                            ...
                            this.#game.zone.add({
                                x: x + 8 + 4, y: y + 16, w: 8, h: 8, t: 'bush_hit'
                            });
                            break;
